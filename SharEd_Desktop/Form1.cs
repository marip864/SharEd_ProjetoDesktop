...
namespace SharEd_Desktop
{
    public partial class TelaInicial : Form
    {
        ...
        {
            if ((Application.OpenForms.OfType<ReativarTurma>().Count() == 0) && (Application.OpenForms.OfType<ConsultaAlunoTurma>().Count() == 0) && (Application.OpenForms.OfType<ConsultaProfessorTurma>().Count() == 0) && (Application.OpenForms.OfType<CadastroTurma>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoTurma>().Count() == 0) && (Application.OpenForms.OfType<CadastroAlunoTurma>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoAlunoTurma>().Count() == 0) && (Application.OpenForms.OfType<CadastroProfessorTurma>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoProfessorTurma>().Count() == 0) && (Application.OpenForms.OfType<CadastroDisciplina>().Count() == 0) && (Application.OpenForms.OfType<CadastroTema>().Count() == 0) &&(Application.OpenForms.OfType<ConsultaDisciplina>().Count() == 0) && (Application.OpenForms.OfType<CadastroAluno>().Count() == 0) && (Application.OpenForms.OfType<CadastroMonitor>().Count() == 0) && (Application.OpenForms.OfType<CadastroProfessor>().Count() == 0) && (Application.OpenForms.OfType<CadastroDiretor>().Count() == 0) && (Application.OpenForms.OfType<CadastroAdministrador>().Count() == 0) && (Application.OpenForms.OfType<AtualizacaoAluno>().Count() == 0) && (Application.OpenForms.OfType<AtualizacaoMonitor>().Count() == 0) && (Application.OpenForms.OfType<AtualizacaoProfessor>().Count() == 0) && (Application.OpenForms.OfType<AtualizacaoDiretor>().Count() == 0) && (Application.OpenForms.OfType<AtualizacaoAdministrador>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoAluno>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoMonitor>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoProfessor>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoDiretor>().Count() == 0) && (Application.OpenForms.OfType<ExclusaoAdministrador>().Count() == 0))
            {
